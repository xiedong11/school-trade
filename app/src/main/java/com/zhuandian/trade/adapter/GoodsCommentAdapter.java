 ...
 * date：2020/03/07
 */
public class GoodsCommentAdapter extends BaseAdapter<GoodsCommentEntity, BaseViewHolder> {
    ...
    TextView tvContent;
    public GoodsCommentAdapter(List<GoodsCommentEntity> mDatas, Context context) {
        super(mDatas, context);
    }

    @Override
    protected void converData(BaseViewHolder holder, GoodsCommentEntity comment, int position) {
